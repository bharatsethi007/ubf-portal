-- PortConnect: extra container_tracking fields + board RPC iso type for pills
ALTER TABLE public.container_tracking
  ADD COLUMN IF NOT EXISTS empty_return_depot_code text,
  ADD COLUMN IF NOT EXISTS empty_return_depot_name text,
  ADD COLUMN IF NOT EXISTS security_check text,
  ADD COLUMN IF NOT EXISTS previous_container_visit_id bigint;
