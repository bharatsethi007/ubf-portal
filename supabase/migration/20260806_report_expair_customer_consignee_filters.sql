...
create function public.report_expair_trend(p_from date, p_to date, p_destination text default null, p_customer text default null, p_consignee text default null)
...
create function public.report_expair_lanes(p_from date, p_to date, p_destination text default null, p_customer text default null, p_consignee text default null, p_limit integer default 50)
...
create function public.report_expair_parties(p_from date, p_to date, p_destination text default null, p_customer text default null, p_consignee text default null, p_limit integer default 50)
...
create function public.report_expair_customers(p_from date, p_to date)
...
create function public.report_expair_consignees(p_from date, p_to date)
...
grant execute on function public.report_expair_trend(date,date,text,text,text) to authenticated;
grant execute on function public.report_expair_lanes(date,date,text,text,text,integer) to authenticated;
grant execute on function public.report_expair_parties(date,date,text,text,text,integer) to authenticated;
grant execute on function public.report_expair_customers(date,date) to authenticated;
grant execute on function public.report_expair_consignees(date,date) to authenticated;
