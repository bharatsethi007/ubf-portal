...
const s = StyleSheet.create({
  ...
  ck: { fontWeight: 700 },
  badge: { marginTop: 4, backgroundColor: INK, color: '#fff', fontWeight: 700, fontSize: 9, letterSpacing: 1, paddingVertical: 3, paddingHorizontal: 7 },
      ...
      <Page size="A4" style={s.page}>
        ...
        {(d.cargo ?? []).map((l) => (
          <View style={s.tr} key={l.id} wrap={false}>
            ...
            <Text style={[s.td, s.cDg, dg ? { color: '#e11d1d', fontWeight: 700 } : {}]}>{dg ? 'DG' : 'General'}</Text>
