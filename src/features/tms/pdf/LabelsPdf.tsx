...
const s = StyleSheet.create({
  ...
  badge: { backgroundColor: INK, color: '#fff', fontWeight: 600, fontSize: 10, letterSpacing: 1, paddingVertical: 4, paddingHorizontal: 8 },
  pcount: { fontWeight: 600, fontSize: 16 },
  ...
  fromCo: { fontWeight: 600, marginTop: 1, fontSize: 12 },
  ...
  pieceNo: { fontSize: 12, fontWeight: 600 },
