...
export default function FclRateCardForm() {
  ...
  async function onSubmit() {
    ...
    setError('')
    try {
      await createFclRateCard({ shipping_line_code: shippingLine, vendor_account_id: vendor?.account_id ?? '', vendor_name: vendor?.name ?? '', title: title.trim(), currency_code: currency, valid_from: validFrom, valid_to: validTo })
