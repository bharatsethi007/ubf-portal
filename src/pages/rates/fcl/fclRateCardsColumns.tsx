...
import type { FclRateCardRow } from '../ratesApi'

export const FCL_STATUS_TABS = [
  { key: 'all', label: 'All' },
...
export function fclStatusPill(status: string) {
...
export function fclRateCardsColumns(): ColumnDef<FclRateCardRow>[] {
  return [
    { header: 'Shipping line', accessorKey: 'shipping_line_code', cell: ({ row }) => row.original.shipping_line_name ?? row.original.shipping_line_code },
